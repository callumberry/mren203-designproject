...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("projector_mode", "int", 31, "Indicates whether the projector should be off, on when in use or on all the time.", "{'enum': [{'name': 'ProjectorOff', 'type': 'int', 'value': 1, 'srcline': 56, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The projector is always off.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ProjectorAuto', 'type': 'int', 'value': 2, 'srcline': 57, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The projector is on if one of the cameras is using it.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ProjectorOn', 'type': 'int', 'value': 3, 'srcline': 58, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The projector is always on.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The projectors operating mode.'}", &CameraSynchronizerConfig::projector_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("wide_stereo_trig_mode", "int", 3, "Indicates the triggering mode of the wide stereo camera.", "{'enum': [{'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for the wide camera.'}", &CameraSynchronizerConfig::wide_stereo_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("wide_stereo_trig_mode", "int", 3, "Indicates the triggering mode of the wide stereo camera.", "{'enum': [{'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for the wide camera.'}", &CameraSynchronizerConfig::wide_stereo_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("narrow_stereo_trig_mode", "int", 3, "Indicates the triggering mode of the narrow stereo camera.", "{'enum': [{'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AlternateProjector', 'type': 'int', 'value': 5, 'srcline': 65, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera alternates between frames with and without the projector.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for the narrow camera.'}", &CameraSynchronizerConfig::narrow_stereo_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("narrow_stereo_trig_mode", "int", 3, "Indicates the triggering mode of the narrow stereo camera.", "{'enum': [{'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AlternateProjector', 'type': 'int', 'value': 5, 'srcline': 65, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera alternates between frames with and without the projector.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for the narrow camera.'}", &CameraSynchronizerConfig::narrow_stereo_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("forearm_r_trig_mode", "int", 4, "Indicates the triggering mode of the right forearm camera.", "{'enum': [{'name': 'InternalTrigger', 'type': 'int', 'value': 1, 'srcline': 61, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera does not use the trigger input.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for a forearm camera.'}", &CameraSynchronizerConfig::forearm_r_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraSynchronizerConfig::AbstractParamDescriptionConstPtr(new CameraSynchronizerConfig::ParamDescription<int>("forearm_l_trig_mode", "int", 8, "Indicates the triggering mode of the left forearm camera.", "{'enum': [{'name': 'InternalTrigger', 'type': 'int', 'value': 1, 'srcline': 61, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera does not use the trigger input.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'IgnoreProjector', 'type': 'int', 'value': 2, 'srcline': 62, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The cameras frequency can be set independently of the projector frequency. There is no deterministic phase relation between projector firing and camera triggering.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithProjector', 'type': 'int', 'value': 3, 'srcline': 63, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is on.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WithoutProjector', 'type': 'int', 'value': 4, 'srcline': 64, 'srcfile': '/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg', 'description': 'The camera always exposes while the projector is off.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'The triggering mode for a forearm camera.'}", &CameraSynchronizerConfig::forearm_l_trig_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 56 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorOff = 1;
//#line 57 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorAuto = 2;
//#line 58 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_ProjectorOn = 3;
//#line 61 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_InternalTrigger = 1;
//#line 62 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_IgnoreProjector = 2;
//#line 63 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_WithProjector = 3;
//#line 64 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
      const int CameraSynchronizer_WithoutProjector = 4;
//#line 65 "/home/gonk/mren203_ws/src/gazebo_ros_pkgs/gazebo_plugins/cfg/CameraSynchronizer.cfg"
